...
import '../ListaProgramacaoPDF/listaprogramacaoPDF.css';

function ListaProgramacaoPDF(props) {
    ...
    <thead>
        ...
        <tr >
            ...
            {ok === 'S' ? <th class= 'th2'>Amostra</th> : null}
            <th class= 'th3'>Nº</th>
            {/* <th scope="col">Prof.Inicial(m)</th>
            <th scope="col">Prof.Final(m)</th>
            <th scope="col">COORD.N</th>
            <th scope="col">COORD.E</th>
            <th scope="col">Descricao</th>
            <th scope="col">Arq.</th>
            {rmassavolumica === 'S' ? <th scope="col">MVRG</th> : null}
            {rteoragua === 'S' ? <th scope="col">TW</th> : null}
            {rcortedirecto === 'S' ? <th className='th' scope="col">CD</th> : null}
            ...
            {rcompactacaonormal === 'S' ? <th scope="col">PROT</th> : null}
...
export default ListaProgramacaoPDF;